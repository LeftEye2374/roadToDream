...
namespace AutoLot.Dal.BulkImport
{
    public sealed class MyDataReader<T> : IMyDataReader<T>
    {
        ...
        public MyDataReader(List<T> reacords, SqlConnection connection, string schema, string tableName)
        {
            Records = reacords;
        ...
        public short Getlntl6(int i) => throw new NotImplementedException();
        public int Getlnt32(int i) => throw new NotImplementedException();
        public long Getlnt64(int i) => throw new NotImplementedException();
        ...
        public bool NextResultO => throw new NotImplementedException();
